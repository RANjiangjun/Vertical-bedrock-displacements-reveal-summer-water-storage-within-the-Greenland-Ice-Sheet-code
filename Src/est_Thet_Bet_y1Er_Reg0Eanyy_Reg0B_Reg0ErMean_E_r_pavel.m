...
function [a,trend,c2,c3,E_r,theta,invbeta,time_series_simulated,discharge,meltwater,meltwater_orig,formal_error_calibrated_invbeta,calibrated_formal_error_meltwarer,intergated_upstream_runoff_per_year,intergated_upstream_runoff_per_year_orig,formal_error_calibrated_E_r]=est_Thet_Bet_y1Er_Reg0Eanyy_Reg0B_Reg0ErMean_E_r_pavel(npol,year_reg,invbeta_reg,ErMeanReg,nit,damping_scaling,time,GNSS_loading_time_series,SMB_time_series,liquid_p_time_series,runoff_time_series,year_beg,year_end)
%
% Input parameters:
