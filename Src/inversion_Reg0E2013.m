...
%             [a,trend,c2,c3,E_r,theta,invbeta,time_series_simulated,discharge,meltwater,meltwater_orig,formal_error_calibrated_invbeta,calibrated_formal_error_meltwarer,intergated_upstream_runoff_per_year,intergated_upstream_runoff_per_year_orig]=est_Thet_Bet_y1Er_Reg0Eanyy_Reg0B_2022_3_11_ocean(2,2013,0.2,15,1.,GPS_time_series_running_mean_period_interpolated_clean_reduced(:,1),GPS_time_series_running_mean_period_interpolated_clean_reduced(:,2),RACMO_SMB_selected_period_interpolated_reduced(:,2),liquid_p_time_series_reduced(:,2),RACMO_runoff_selected_period_interpolated_reduced(:,2),year_start,year_end);
            [a,trend,c2,c3,E_r,theta,invbeta,time_series_simulated,discharge,meltwater,meltwater_orig,formal_error_calibrated_invbeta,calibrated_formal_error_meltwarer,intergated_upstream_runoff_per_year,intergated_upstream_runoff_per_year_orig,formal_error_calibrated_E_r]=est_Thet_Bet_y1Er_Reg0Eanyy_Reg0B_Reg0ErMean_E_r_pavel(2,2013,0.,1.,15,1.,GPS_time_series_running_mean_period_interpolated_clean_reduced(:,1),GPS_time_series_running_mean_period_interpolated_clean_reduced(:,2),RACMO_SMB_selected_period_interpolated_reduced(:,2),liquid_p_time_series_reduced(:,2),RACMO_runoff_selected_period_interpolated_reduced(:,2),year_start,year_end);
            % peak mass per year
...
%             [a,trend,c2,c3,E_r,theta,invbeta,time_series_simulated,discharge,meltwater,meltwater_orig,formal_error_calibrated_invbeta,calibrated_formal_error_meltwarer,intergated_upstream_runoff_per_year,intergated_upstream_runoff_per_year_orig]=est_Thet_Bet_y1Er_Reg0Eanyy_Reg0B_2022_3_11_ocean(2,0.,0.2,15,1.,GPS_time_series_running_mean_period_interpolated_clean_reduced(:,1),GPS_time_series_running_mean_period_interpolated_clean_reduced(:,2),RACMO_SMB_selected_period_interpolated_reduced(:,2),liquid_p_time_series_reduced(:,2),RACMO_runoff_selected_period_interpolated_reduced(:,2),year_start,year_end);
            [a,trend,c2,c3,E_r,theta,invbeta,time_series_simulated,discharge,meltwater,meltwater_orig,formal_error_calibrated_invbeta,calibrated_formal_error_meltwarer,intergated_upstream_runoff_per_year,intergated_upstream_runoff_per_year_orig,formal_error_calibrated_E_r]=est_Thet_Bet_y1Er_Reg0Eanyy_Reg0B_Reg0ErMean_E_r_pavel(2,0.,0.,1.,15,1.,GPS_time_series_running_mean_period_interpolated_clean_reduced(:,1),GPS_time_series_running_mean_period_interpolated_clean_reduced(:,2),RACMO_SMB_selected_period_interpolated_reduced(:,2),liquid_p_time_series_reduced(:,2),RACMO_runoff_selected_period_interpolated_reduced(:,2),year_start,year_end);
            % peak mass per year
            meltwater_year=meltwater;
            meltwater_file='max_meltwater_year_';
%             meltwater_year=meltwater_orig; % RACMO meltwater production
...
%            [a,trend,c2,c3,E_r,theta,invbeta,time_series_simulated,discharge,meltwater,meltwater_orig,formal_error_calibrated_invbeta,calibrated_formal_error_meltwarer,intergated_upstream_runoff_per_year,intergated_upstream_runoff_per_year_orig]=est_Thet_Bet_y1Er_Reg0Eanyy_Reg0B_2022_3_11_ocean(2,2013,0.,1.,15,1.,GPS_time_series_running_mean_period_interpolated_clean_reduced(:,1),GPS_time_series_running_mean_period_interpolated_clean_reduced(:,2),RACMO_SMB_selected_period_interpolated_reduced(:,2),liquid_p_time_series_reduced(:,2),RACMO_runoff_selected_period_interpolated_reduced(:,2),year_start,year_end);
            [a,trend,c2,c3,E_r,theta,invbeta,time_series_simulated,discharge,meltwater,meltwater_orig,formal_error_calibrated_invbeta,calibrated_formal_error_meltwarer,intergated_upstream_runoff_per_year,intergated_upstream_runoff_per_year_orig,formal_error_calibrated_E_r]=est_Thet_Bet_y1Er_Reg0Eanyy_Reg0B_Reg0ErMean_E_r_pavel(2,2013,0.,1.,15,1.,GPS_time_series_running_mean_selected_period_interpolated_clean(:,1),GPS_time_series_running_mean_selected_period_interpolated_clean(:,2),RACMO_SMB_selected_period_interpolated(:,2),liquid_p_time_series(:,2),RACMO_runoff_selected_period_interpolated(:,2),year_start,year_end);
            % peak mass per year
            meltwater_year=meltwater;
            meltwater_file='max_meltwater_year_';
%             meltwater_year=meltwater_orig; % RACMO meltwater production
...
%             [a,trend,c2,c3,E_r,theta,invbeta,time_series_simulated,discharge,meltwater,meltwater_orig,formal_error_calibrated_invbeta,calibrated_formal_error_meltwarer,intergated_upstream_runoff_per_year,intergated_upstream_runoff_per_year_orig]=est_Thet_Bet_y1Er_Reg0Eanyy_Reg0B_2022_3_11_ocean(2,0.,0.2,15,1.,day_decimal_year(:,1),GPS_time_series_running_mean_selected_period_interpolated_clean(:,2),RACMO_SMB_selected_period_interpolated(:,2),liquid_p_time_series(:,2),RACMO_runoff_selected_period_interpolated(:,2),year_start,year_end);
            [a,trend,c2,c3,E_r,theta,invbeta,time_series_simulated,discharge,meltwater,meltwater_orig,formal_error_calibrated_invbeta,calibrated_formal_error_meltwarer,intergated_upstream_runoff_per_year,intergated_upstream_runoff_per_year_orig,formal_error_calibrated_E_r]=est_Thet_Bet_y1Er_Reg0Eanyy_Reg0B_Reg0ErMean_E_r_pavel(2,0.,0.,1.,15,1.,GPS_time_series_running_mean_selected_period_interpolated_clean(:,1),GPS_time_series_running_mean_selected_period_interpolated_clean(:,2),RACMO_SMB_selected_period_interpolated(:,2),liquid_p_time_series(:,2),RACMO_runoff_selected_period_interpolated(:,2),year_start,year_end);
            % peak mass per year
            meltwater_year=meltwater;
            meltwater_file='max_meltwater_year_';
%             meltwater_year=meltwater_orig; % RACMO meltwater production
